\begin{table}[htbp]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects with covariate adjustment -- Risk aversion} \label{tab:REG-riskcontrols} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{6}{c}} \toprule
...
\midrule
Coefficient of relative risk aversion&         &     0.19&-0.25\sym{**}&         &         &-0.44\sym{**}\\
          &         &   (0.19)&   (0.13)&         &         &   (0.22)\\
          &         &         &         &         &         &         \\
