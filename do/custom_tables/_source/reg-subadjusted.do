...
mat B = r(p) 
stepdown reg (`endvars') uct insured inc_highgroup_0 inc_midgroup_0 `basevars' if havenationalid_0, iter($iterations)	
mat C = r(p)
stepdown reg (`endvars') insured uct inc_highgroup_0 inc_midgroup_0 `basevars' if havenationalid_0, iter($iterations)	
mat D = r(p) 
