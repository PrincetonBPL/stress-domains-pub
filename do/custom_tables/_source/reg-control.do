** Title: reg-control.do
** Author: Justin Abraham
** Desc: Outputs regression table comparing regression with full controls
** Output: reg-control.tex
...
foreach yvar in $regvars {
	...
	* Model to be displayed:
	reg `yvar'_1 uct insured inc_highgroup_0 inc_midgroup_0 `yvar'_0 $controlvars
	est store spec2_`varindex'
	loc surlist2 "`surlist1' spec1_`varindex'"

	reg `yvar'_1 uct insured inc_highgroup_0 inc_midgroup_0 `yvar'_0 $controlvars, vce(r)
