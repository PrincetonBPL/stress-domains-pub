...
esttab col* using "$tab_dir/REG-comparetime.tex", booktabs cells(none) nonum mgroups("TSST-G" "CPT" "CENT" "Overall", pattern(1 0 1 0 1 0 1) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitle("Effect" "N" "Effect" "N" "Effect" "N" "Control mean") stats(`statnames', labels(`varlabels')) note("`footnote'") prehead("`prehead'") postfoot("`postfoot'") compress wrap replace
esttab col* using "$tab_dir/REG-comparetime-frag.tex", booktabs cells(none) nonum mgroups("TSST-G" "CPT" "CENT" "Overall", pattern(1 0 1 0 1 0 1) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) mtitle("Effect" "N" "Effect" "N" "Effect" "N" "Control mean") stats(`statnames', labels(`varlabels')) compress wrap replace
